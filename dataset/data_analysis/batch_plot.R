...
root_directory <- "C:/ADD_SOURCE/"

type_name <- "/Funnel/"

directory <- paste(root_directory, type_name, "/csv/", sep = "")
out_directory <- paste(root_directory, type_name, "/result/", sep = "")
png_directory <- paste(root_directory, type_name, "/png/", sep = "")
