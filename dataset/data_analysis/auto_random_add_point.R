...
rootDirectory <- "D:/InfoVis/Scag_Data_Builder/TEMP/"
issueDirectory <- "D:/InfoVis/Scag_Data_Builder/TEMP/issue/"
outDirectory <- "D:/InfoVis/Scag_Data_Builder/Modified_Data/Add_point/"
suffix <- ".csv"
issueName <- "/issue.csv"
...
auto_add_plot <- function(filename, addRate, head, outPngName, outCSVName, outDataName, color)
{
    ...
    max_y <- max_y * range_xy    
    min_y <- min_y * range_xy
