...
public class Scagnostics {
    ...
    private List outlierEdges;
    private List runtsEdges;
    private List selectMaxEdges;
    ...
    public void outputNode(String filename, double[] x, double[] y) {
        String strtemp;
        File file = new File(filename);
    ...
    private double computeClusterMeasure() {
        ...
        double maxValue = 0;
        Edge[] maxEdge = new Edge[1];
        Node p1_tmp = new Node(0, 0, 1, 0);
        Node p2_tmp = new Node(0, 0, 1, 1);
        Edge tmpEdge = new Edge(p1_tmp, p2_tmp);
